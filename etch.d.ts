...
type ElementClassConstructor<T extends JSX.ElementClass> = new (props: T['props'], children: JSX.Element[]) => T;

declare namespace JSX {
  type Element = { tag: TagSpec, props?: EtchAttributes | Props, children: Element[] }
               | { text: string | number }
  interface Props {
     ref?: string
  }
